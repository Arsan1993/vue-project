<template>
    <ul class="catalog__pagination pagination" @click.prevent="previous(pageNumber)">
          ...
          <li class="pagination__item" @click.prevent="next(pageNumber)">
